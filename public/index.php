...
<html>
  ...
  <body>
    <div class="wrapper">
      ...
      $ban = getBanner(3, $_GET["id"])
      ?>
      
      -->
      <div class="main_body">
        <div class="best">Best Deals</div>
        <div class="category"><a href="/company.php?id_cat=5">Meizu</a><a href="/company.php?id_cat=1">Apple</a><a href="/company.php?id_cat=3">Samsung</a><a href="/company.php?id_cat=4">Huawei</a><a href="/company.php?id_cat=2">Google</a></div>
        <div class="tovars">
          <?php
          for($i = 0; $i<count($ban); $i++){
          echo " <div class=\"device_info\">";
          echo '<span>'.$ban[$i]["title"].'</span><img src="img/tovars/'.$ban[$i]["image"].'.jpg" alt=""/>
          <div class="bttns" style="margin-top: 8px;">
          <div class="shop_bttn bottom">buy now</div>
          <div class="bottom"><a href="/article.php?id='.$ban[$i]["id"].'">learn more</a></div>
          </div>
          </div>';
          }
          ?>
        </div><span class="asd">New Devices</span>
        <div class="tovars">
          <?php
          ...
          <div class="bttns" style="margin-top: 8px;">
          <div class="shop_bttn bottom">buy now</div>
          <div class="bottom"><a href="/article.php?id='.$news[$i]["id"].'">learn more</a></div>
          </div>
          </div>';
          }
          ?>
